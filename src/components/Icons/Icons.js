...
export const MessageIcons = ({ width = '3.2rem', height = '3.2rem', className }) => (
    ...
    >
        <path
            ...
            fill="none"
            stroke="currentColor" strokeMiterlimit="10" strokeWidth="1.739">
        </path>
...
export const SearchIcons = ({ width = '3.2rem', height = '3.2rem', className }) => (
    ...
    >
        <path
            d="M19 10.5A8.5 8.5 0 1 1 10.5 2a8.5 8.5 0 0 1 8.5 8.5Z" fill="none"
            stroke="currentColor"
            strokeLinecap="round"
...
export const SearchActiveIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
       className={className}
        ...
        fill="currentColor"
        viewBox="0 0 24 24"
    ><path d="M18.5 10.5a8 8 0 1 1-8-8 8 8 0 0 1 8 8Z" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3"></path><line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" x1="16.511" x2="21.643" y1="16.511" y2="21.643"></line></svg>
);
export const HomeIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        ...
        viewBox="0 0 24 24"
       >
        <path d="M9.005 16.545a2.997 2.997 0 0 1 2.997-2.997A2.997 2.997 0 0 1 15 16.545V22h7V11.543L12 2 2 11.543V22h7.005Z" fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth="2"></path></svg>
);
...
export const ReelsIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    ...
    >
        <line
            ...
            stroke="currentColor"
            strokeLinejoin="round"
            strokeWidth="2" x1="2.049" x2="21.95" y1="7.002" y2="7.002">
        </line>
