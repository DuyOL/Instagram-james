...
import video from '~/pages/Home/Videos/video6.mp4';
    ...
    <div className={cx("container")}>
      <div className={cx("content")}>
        ...
        <div className={cx("detail-list")}>
          <p className={cx("detail-like")}>32.421.331 lượt xem</p>
          <p className={cx("detail-comment")}>
            Các đội bóng mạnh nhất Ngoại Hạng Anh 👑 👑 👑 <br />
          </p>
          <p className={cx("detail-more")}>Xem thêm</p>
          <p className={cx("detail-translation")}>Xem bản dịch</p>
          <p className={cx("detail-seeall")}>Xem tất cả 15.119.812 bình luận</p>
        </div>
        <div>
